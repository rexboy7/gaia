...
(function(exports) {
  /**
   * CardNavigator Element
   *
   * An element that you want to let CardNavigator can navigate to.
   *
   ...
   * position and size by {@link CardNavigatorRectCalcFunc}.
   *
   * @typedef {Object} CardNavigatorElement
   */

  /**
   * CardNavigator Rect Calculating Function
   *
   * A callback function which can describe the position and size of a
   * {@link CardNavigatorElement}.
   *
   * @callback CardNavigatorRectCalcFunc
   * @param {CardNavigatorElement} element
  ...
  /**
   * CardNavigator is a helper for simulating navigation in
   * javascript level.
   *
   ...
   *        An initial set of {@link CardNavigatorElement} for traversal.
   * @param {CardNavigatorRectCalcFunc} [rectCalcFunc=null]
   *        A callback function which can describe the position and size of
   *        each {@link CardNavigatorElement}.
   */
  function CardNavigator(collection, rectCalcFunc) {
  ...
  CardNavigator.prototype = evt({
    /**
     * Limit the navigating direction to vertical and horizontal only.
     * @type {Boolean}
     * @memberof CardNavigator.prototype
     */
    crossOnly: false,

    /**
     * Get the "rect" object from a {@link CardNavigatorElement}.
     *
     * It tries to calculate with {@link CardNavigatorRectCalcFunc} first. If
     * "rectCalcFunc" is omitted or returns "null", the fallback rules will be
     * involved then.
     *
     * @access private
     * @param  {CardNavigatorElement} elem The element you want to calculate.
     ...
     *
     * @access private
     * @param  {CardNavigatorElement} [exclusive_elem]
    ...
    /**
     * Set {@link CardNavigatorRectCalcFunc} for CardNavigator.
     *
     * @param  {CardNavigatorRectCalcFunc} [rectCalcFunc=null]
     *         A callback function that CardNavigator can calculate the
     ...
     * Add an element.
     *
     * @param  {CardNavigatorElement} elem
     ...
     *
     * @return A {CardNavigatorElement} or "null" if nothing focused.
     * @memberof CardNavigator.prototype
     */
     ...
     * specified direction.
     *
     * @param {CardNavigatorElement} target The origin of coordinates for
     *                                         traversal.
     * @param {String} direction It should be "left", "right", "up" or "down".
     * @return {CardNavigatorElement} The destination of the element which
  ...
  exports.CardNavigator = CardNavigator;
})(window);
