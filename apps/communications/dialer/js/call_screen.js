...
var CallScreen = {
  ...
  showGroupsButton: document.getElementById('groups-show'),
  hideGroupsButton: document.getElementById('groups-hide'),
  ...
  init: function cs_init() {
    ...
    this.showGroupsButton.addEventListener('click',
                                    CallScreen.showGroups.bind(this));

    this.hideGroupsButton.addEventListener('click',
                                    CallScreen.hideGroups.bind(this));
    ...
    this.calls.addEventListener('click', function(evt) {
      if (evt.target.id == 'groups-show') {
        return;
      }
  ...
  showGroups: function cs_showGroupDetails() {
    this.groupCalls.classList.add('display');
  },

  hideGroups: function cs_hideGroupDetails(evt) {
    if (evt) {
      evt.preventDefault();
    }
